 ...
 * Created by dennis
 */
public class EmojiButton extends AppCompatButton implements EmojiViewInterface{
  ...
  /**
   * sets the emoji size in pixels and automatically invalidates the text and renders it with the
   * new size when {@code shouldInvalidate} is true
   */
  @Override
  ...
  /**
   * sets the emoji size in pixels with the provided resource and automatically invalidates the text
   * and renders it with the new size
   */
  @Override
  ...
  /**
   * sets the emoji size in pixels with the provided resource and invalidates the text and renders
   * it with the new size when {@code shouldInvalidate} is true
   */
  @Override
